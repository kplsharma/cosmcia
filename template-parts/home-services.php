...
$data = cosmica_get_theme_var();
?>
<div class="clearfix"></div>
<div class="home-wrapper service-wrapper">
    <div class="container">
        <div class="section-title-heading">
            <h2 class="section-title wow zoomIn"><?php echo esc_html($cosmca_services_header_text); ?></h2>
            <div class="separator-solid"></div>
            <p class="section-description wow slideInUp"><?php echo esc_html($cosmca_services_desc_text); ?></p>
        </div>
                ...
                <div class="col-md-4 col-sm-6 cosmica-service wow bounceIn" data-wow-delay="300ms">
                    <div class="service-inner">
                        ...
                        <div class="service-info media-body">
                            <h3 class="service-title"><?php echo esc_html($data['cosmca_services_'.$i.'_title']); ?></h3>
                            <p class="service-description"><?php echo esc_html($data['cosmca_services_'.$i.'_desc']); ?></p>
