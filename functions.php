...
function cosmica_social_links() {
    ...
    ?>
        <ul class="cs-socials">
            <li><a href="<?php echo esc_url($social_link_facebook); ?>" class="topbar-icon" <?php echo $link_in_new_tab; ?>><i class="fa fa-facebook"></i></a></li>
            <li><a href="<?php echo esc_url($social_link_google); ?>" class="topbar-icon" <?php echo $link_in_new_tab; ?>><i class="fa fa-google-plus"></i></a></li>
            <li><a href="<?php echo esc_url($social_link_youtube); ?>" class="topbar-icon" <?php echo $link_in_new_tab; ?>><i class="fa fa-youtube"></i></a></li>
            <li><a href="<?php echo esc_url($social_link_twitter); ?>" class="topbar-icon" <?php echo $link_in_new_tab; ?>><i class="fa fa-twitter"></i></a></li>
            <li><a href="<?php echo esc_url($social_link_linkedin); ?>" class="topbar-icon" <?php echo $link_in_new_tab; ?>><i class="fa fa-linkedin"></i></a></li>
        </ul>
    <?php
}
...
require_once get_template_directory() . '/includes/comica-variables.php';
